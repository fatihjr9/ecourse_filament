...
<body class="bg-gray-50 h-screen flex flex-col justify-between">
    <div>
        <header class="py-6 px-6 lg:px-20 border-b bg-white">
            <nav class="hidden lg:flex flex-row items-center justify-between">
            ...
            <nav class="flex lg:hidden flex-row items-center justify-between">
                <h5>Software Mahasiswa</h5>
                <button class="" type="button" data-drawer-target="drawer-right-example" data-drawer-show="drawer-right-example" data-drawer-placement="right" aria-controls="drawer-right-example">open</button>
